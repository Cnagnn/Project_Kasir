{{-- STOCK DETAIL CONTENT (For AJAX Loading) --}}
...
<div class="col-sm-12" style="padding-left: 0; padding-right: 0;">
            ...
            <div class="table-responsive">
                <table class="table table-hover table-centered">
                    ...
                    <tbody>
                                    ...
                                    <td>
                                        <div class="action-btn-group" role="group" aria-label="Aksi batch">
                                            ...
                                            <form 
                                                ...
                                                method="POST" class="form-delete-batch d-inline-block">
                                                @csrf
                                                @method('DELETE')
                        ...
                        @empty
                            <tr>
                                <td colspan="8" class="text-center">Belum ada data batch stok untuk produk ini.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
        ...
        <div class="col-lg-12 mb-3">
            <button class="btn btn-primary btn-back-to-stock-list">
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('.form-delete-batch').on('submit', function(event) {
            ...
            Swal.fire({
                ...
                text: `Anda akan menghapus batch dari produk "${productName}".`,
                icon: 'warning',
